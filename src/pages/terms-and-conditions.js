...
const terms = () => {
  return (
    <StyledPolicy>
      ...
      <span className="text">
        Welcome to the Terms ^& Conditions of INTD$. By using our <br />
        services, you agree to the following fake terms and conditions:
      </span>
      <ul>
        <li>
      ...
      <div className="foot-text">
        ...
        <Button width="400px">
          <Image src={downloadIcon} alt="downloadIcon" /> Download Terms &
          Conditions
        </Button>
      </div>
    </StyledPolicy>
